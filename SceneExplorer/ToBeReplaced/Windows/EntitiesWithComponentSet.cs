...
namespace SceneExplorer.ToBeReplaced.Windows
{
    public class EntitiesWithComponentSet : FloatingWindowBase
    {
        ...
        // bool prev = _searchByQuery;
        // _searchByQuery = GUILayout.Toggle(_searchByQuery, "Entity Query search", options: null);
        // if (prev != _searchByQuery)
        // {
        //     _updateInterval = 0;
        //     _lastUpdate = 0;
        //     _queryCreator.Clear();
        ...
        public void Update() {
        if (_snapshotEntities.WasReleasedThisFrame() && _items.Count > 0)
        {
