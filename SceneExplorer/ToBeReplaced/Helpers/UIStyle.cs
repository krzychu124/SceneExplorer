...
namespace SceneExplorer.ToBeReplaced.Helpers
{
    public class UIStyle
    {
        ...
        {
            normal = { background = _titleHoverTexture }, active = { background = _commonHoverTexture }, onActive = { background = _commonHoverTexture }, onNormal = { background = _commonHoverTexture },
            hover = { background = _commonHoverTexture }, onHover = { background = _commonHoverTexture }
        };
        ...
        _skin.horizontalSliderThumb = new GUIStyle(GUI.skin.horizontalSliderThumb)
            { normal = { background = _bgTexture }, active = { background = _bgTexture }, onNormal = { background = _bgTexture }, hover = { background = _bgTexture }, onHover = { background = _bgTexture } };
        _skin.label = new GUIStyle(GUI.skin.label) { margin = new RectOffset(0, 0, 1, 1), padding = new RectOffset(0, 0, 1, 1) };
        ...
        focusedReducedPaddingLabelStyle = new GUIStyle(GUI.skin.label)
            { normal = { textColor = new Color(0.21f, 0.75f, 0f) }, fontStyle = FontStyle.Bold, margin = new RectOffset(0, 0, 1, 1), padding = new RectOffset(1, 1, 1, 1) };
        ...
        {
            margin = new RectOffset(2, 2, 2, 2), padding = new RectOffset(4, 4, 2, 2), normal = { background = _titleHoverTexture }, active = { background = _titleHoverTexture },
            onNormal = { background = _titleHoverTexture }, hover = { background = _commonHoverTexture }, onHover = { background = _commonHoverTexture }
        };
        collapsibleContentStyle = new GUIStyle(GUI.skin.box)
        {
            normal = { background = _bgTexture3 }, active = { background = _bgTexture3 }, onNormal = { background = _bgTexture3 }, hover = { background = _bgTexture3 }, onHover = { background = _bgTexture3 },
            margin = new RectOffset(), padding = new RectOffset(), alignment = TextAnchor.MiddleLeft
        };
